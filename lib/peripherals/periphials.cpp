...
CWG_SerialMonitor SerialTerminal;  // instantiate terminal object from peripherals library

// Serial Monitor function test to establish if monitor is working correctly.
//   Place function call in setup (not loop) to ensure single occurrence of serial
